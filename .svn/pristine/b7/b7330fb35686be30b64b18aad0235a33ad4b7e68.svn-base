...
%>
	<div class="pagingMove">
	  ...
	  %>
      		...
      		<div class="pagebtn">
      		<button type="button" style="" onclick="location.href='<%=request.getContextPath()%>/noticeboard.do?page=<%=paging.getBeginPage() - 1%>'" class="w-btn-outline w-btn-indigo-outline">◁</button>
	  		</div>
	  <%
      ...
      %>	
      		...
      		<div class="pagebtn">
      		<button type="button" style=" " onclick="location.href='<%=request.getContextPath()%>/noticeboard.do?page=<%=i%>'" class="w-btn-outline w-btn-indigo-outline"><%=i%></button>
      		</div>
      <%
             }else {
      %>
      ...
      %>
      		<div class="pagebtn">
     		<button type="button" style="" onclick="location.href='<%=request.getContextPath()%>/noticeboard.do?page=<%=paging.getEndPage() + 1%>'" class="w-btn-outline w-btn-indigo-outline">▷</button>
			</div>
      ...
      %>
      		...
      		<div class="bt_wrap">
            <button type="button" onclick="Registration()" class="btn btn-primary" style="width: 80px; height: 60px; border-radius: 30%">등록</button>
         	</div>
