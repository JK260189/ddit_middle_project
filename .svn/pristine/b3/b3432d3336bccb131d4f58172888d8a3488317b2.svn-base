		...
		<div class="container-fluid">
			...
			<div class="top-right">
				<div class="top-letters">
					...
					<a href="<%=request.getContextPath() %>/memberLogout.do" style="font-size: 0.9em">로그아웃</a>&nbsp;
					<a href="<%=request.getContextPath() %>/noticeboard.do" style="font-size: 0.9em">공지게시판</a>&nbsp;
				</div>
					
				<div class="top-right-button">
					<div class="top-btn-in">
						<div class="fs-2 mb-3">
							<div class="top-icon-1" onclick="Mypage()"> <!-- 마이메뉴 경로 --------------------    -->
